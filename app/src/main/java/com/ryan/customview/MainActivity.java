...
public class MainActivity extends AppCompatActivity {
...

    {
        ...
        mModels.add(new PageModel(R.layout.fragment_drag, R.string.title_drag));//5
        mModels.add(new PageModel(R.layout.fragment_shadow, R.string.title_shadow));
    }
